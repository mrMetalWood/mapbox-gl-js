...
import { rasterDataDrivenUniformValues } from './program/raster-data-driven_program';
...
function drawRaster(painter: Painter, sourceCache: SourceCache, layer: RasterDataDrivenStyleLayer, coords: Array<OverscaledTileID>) {
    ...
    const program = painter.useProgram('rasterDataDriven');
    ...
    for (const coord of coords) {
        ...
        const textureFilter = layer.paint.get('raster-resampling') === 'linear' ? gl.LINEAR : gl.NEAREST;
