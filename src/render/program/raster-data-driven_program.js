...
import type RasterDataDrivenStyleLayer from '../../style/style_layer/raster-data-driven_style_layer';

export type RasterDataDrivenUniformsType = {|
...
const rasterDataDrivenUniforms = (context: Context, locations: UniformLocations): RasterDataDrivenUniformsType => ({
    ...
    'u_look_up_texture': new Uniform1i(context, locations.u_look_up_texture),
...
const rasterDataDrivenUniformValues = (
    matrix: Float32Array,
...
export { rasterDataDrivenUniforms, rasterDataDrivenUniformValues };
